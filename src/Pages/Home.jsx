      ...
      <div className={loading ? 'content-opacity' : 'content-visible'}>
            ...
            <div className="videoPart">
              ...
              <div className="shareReelmeta">
                <ul>
                  ...
                  <li><Link to="/"><span>My Crush</span><img src={Location} alt="Location" /></Link></li>
                  <li><Link to="/"><span>Get Eternal Life</span><img src={Eternal} alt="Eternal Life" /></Link></li>
                </ul>
              </div>
            </div>
            <div className="shareStoryCon">
          ...
          <div className="shareslder">
            ...
            >
              {content.tImages?.map((item, i) => {
                return (
                  <SwiperSlide key={i}>
                    <div className="sliderItm">
                      <img src={serverApi + item} alt={`Slide ${i + 1}`} />
                    </div>
                  </SwiperSlide>
                );
              })}
        ...
        <section className="shareStory shareOffer">
          <div className="shareStoryIn">
            ...
            <div className="shareOfferIn">
              <div className="shareOfferimg">
                <img src={serverApi + content.forthImage} alt="Offer" />
              </div>
              <div className="shareOffertag">
                <img src={FreeTag} alt="Free Tag" />
              </div>
              <div className="shareStoryCon">
        ...
        <section className="homesubmit">
          <div className="homesubmitin">
            ...
            <Button type="submit" variant="danger" onClick={handleNavigate}>
              Submit now
            </Button>
          </div>
        </section>
